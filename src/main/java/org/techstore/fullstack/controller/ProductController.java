...
public class ProductController {
    ...
    @GetMapping("/search")
    public ResponseEntity<ProductDetailsResponse> searchProduct(@RequestParam String value) {
        ProductDetailsResponse productsByCategoryName = productService.findProductBy(value);
        return new ResponseEntity<>(productsByCategoryName, HttpStatus.OK);
    }
}
